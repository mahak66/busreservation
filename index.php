...
<div id="wrapper">
	<div id="header">
    <h1><a href="index.php"><img src="xres/images/logo.png" class="logo" alt="Bus Portal" /></a></h1>
        <ul id="mainnav">
    ...
    <div id="content">
    	<div id="rotator">
			  ...
			  <div id="logo" style="left: 500px; height: auto; top: 23px; width: 260px; position: absolute; z-index:4;">
	...
	<div id="footer">
	<h4>+91 9405586360 &bull; <a href="contact-us.php">Gagangiri Sankul, Pimple Gurav  </a></h4>
	<p>Hours of Operation&nbsp;&nbsp;&bull;&nbsp;&nbsp;Mon - Sun: 10:00 am - 12:00 am</p>
	<!--<a href="index.php"><img src="xres/images/footer-logo.jpg" alt="Bus Portal" /></a>-->
	<p>&copy; Copyright 2018 COEP | All Rights Reserved <br /></p>
</div>
</div>
</body>
</html>
